...
| Evidence ID | Title | Source | Conversation Dates | Review Status | Mining Report | Source Preservation | Promotion Status |
|---|---|---|---|---|---|---|---|
...
- Assign IDs sequentially within each source family.
- Do not renumber an artifact after publication.
- An artifact is not `Fully Mined` until its source is preserved, mining questions are reviewed, and promotion dispositions are recorded.
